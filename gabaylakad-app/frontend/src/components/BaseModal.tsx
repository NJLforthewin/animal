...
const BaseModal: React.FC<BaseModalProps> = ({ open, onClose, children, title, zIndex }) => {
  ...
  <div className="modal-content" style={{ background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px rgba(44,62,80,0.15)', padding: 24, minWidth: 400, maxWidth: 480, width: '90%', position: 'relative' }} onClick={e => e.stopPropagation()}>
